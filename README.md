...
| **Configure plans and offers** | Keep account, offer, plan, identity, operator, and billing boundaries separate | Required Plan Setup view with one independently billed offer per client or service | [`skills/reddit-agency/MULTI-ACCOUNT-OPERATIONS.md`](skills/reddit-agency/MULTI-ACCOUNT-OPERATIONS.md) |
