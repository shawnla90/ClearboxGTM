...
| Metric | Value |
|---|---|
| Tracked post views | **1,561,082** (the public claim stays **1.5M+**) |
...
| Time span | 5.3 months |

Two eras, deliberately run in sequence:

| Era | Items | Views | Days | What it proves |
|---|---|---|---|---|
| Karma-building | 422 | 1,185,453 | 37.9 | A real account, posting on real interests, ramps fast — and never got banned doing it |
...
Deal pipeline (aggregate counts only): 58 lost, 42 open, 15 trial, 5 won.
